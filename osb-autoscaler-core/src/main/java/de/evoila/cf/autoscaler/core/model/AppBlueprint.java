...
public class AppBlueprint {
    ...
    public String toString() {
        return "AppBlueprint{" +
                "scalingIntervalMultiplier=" + scalingIntervalMultiplier +
                ", currentIntervalState=" + currentIntervalState +
                ", minInstances=" + minInstances +
                ", maxInstances=" + maxInstances +
                ", cooldownTime=" + cooldownTime +
                ", learningTimeMultiplier=" + learningTimeMultiplier +
                ...
                ", ramScalingEnabled=" + ramScalingEnabled +
                ", latencyScalingEnabled=" + latencyScalingEnabled +
                ", quotientBasedScalingEnabled=" + quotientBasedScalingEnabled +
                ", predictionScalingEnabled=" + predictionScalingEnabled +
                ", learningEnabled=" + learningEnabled +
                ", billingIntervalConsidered=" + billingIntervalConsidered +
                ", ramUpperLimit=" + ramUpperLimit +
                ", ramLowerLimit=" + ramLowerLimit +
                ", lastScalingTime=" + lastScalingTime +
                ", learningStartTime=" + learningStartTime +
                ", id='" + id + '\'' +
                ", cpuThresholdPolicy='" + cpuThresholdPolicy + '\'' +
                ", requestThresholdPolicy='" + requestThresholdPolicy + '\'' +
                ", ramThresholdPolicy='" + ramThresholdPolicy + '\'' +
                ", latencyThresholdPolicy='" + latencyThresholdPolicy + '\'' +
                ", binding=" + binding +
                '}';
    }
}
