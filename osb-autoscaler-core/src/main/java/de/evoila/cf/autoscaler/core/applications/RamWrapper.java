...
public class RamWrapper {
	 ...
	 */
	public RamWrapper(String thresholdPolicy, long upperLimit, long lowerLimit, boolean ramScalingEnabled, de.evoila.cf.autoscaler.core.applications.ScalableApp assignedApp) {
