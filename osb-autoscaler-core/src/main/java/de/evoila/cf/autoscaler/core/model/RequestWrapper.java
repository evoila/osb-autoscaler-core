...
public class RequestWrapper {
	 ...
	 */
	public RequestWrapper(String thresholdPolicy, int minQuotient, boolean quotientScalingEnabled, de.evoila.cf.autoscaler.core.model.ScalableApp assignedApp) {
