...
public class RamWrapper {
	 ...
	 */
	private final de.evoila.cf.autoscaler.core.model.ScalableApp assignedApp;
	 ...
	 */
	public RamWrapper(String thresholdPolicy, long upperLimit, long lowerLimit, boolean ramScalingEnabled, de.evoila.cf.autoscaler.core.model.ScalableApp assignedApp) {
	...
	public de.evoila.cf.autoscaler.core.model.ScalableApp getAssignedApp() {
		return assignedApp;
	}
	...
	public long getValueOfRam() {
		if (thresholdPolicy.equals(de.evoila.cf.autoscaler.core.model.ScalableApp.MAX))
			return maxOfRam();
		if (thresholdPolicy.equals(de.evoila.cf.autoscaler.core.model.ScalableApp.MIN))
			return minOfRam();
		if (thresholdPolicy.equals(de.evoila.cf.autoscaler.core.model.ScalableApp.MEAN))
			return meanOfRam();
