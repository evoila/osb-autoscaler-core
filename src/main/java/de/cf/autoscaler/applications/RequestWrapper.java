...
import de.cf.autoscaler.scaling.Scaler;
...
public class RequestWrapper {
	 ...
	 */
	public RequestWrapper(String thresholdPolicy, int minQuotient, boolean quotientScalingEnabled, ScalableApp assignedApp) {
